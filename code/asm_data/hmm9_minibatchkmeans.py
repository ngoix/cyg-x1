...
Html_file = open("hmm_pomegranate_files/hmm9_minibatchkmeans.html", "w")
...
plt.savefig('hmm_pomegranate_files/hmm9_minibatch_transition.png')
data_uri = open(
    'hmm_pomegranate_files/hmm9_minibatch_transition.png',
