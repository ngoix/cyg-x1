...
Html_file = open("hmm_pomegranate_files/hmm9_dbscan.html", "w")
...
plt.savefig('hmm_pomegranate_files/hmm9_dbscan_transition.png')
data_uri = open(
    'hmm_pomegranate_files/hmm9_dbscan_transition.png',
